...
@Component({
  ...
  template: `
        <app-header [pageTitle]="'Clients list'"></app-header>
...
export class ClientListComponent {
  ...
  setEdit(field: 1 | 2 | 3, value: boolean) {
    if (field === 1) {
      this.editName = value;
    }
    if (field === 2) {
  ...
  saveInput(client: any, filed: 1 | 2 | 3, input: any) {
    const value = input.value;
    client.name = value;
    this.setEdit(filed, false);
  }
}
